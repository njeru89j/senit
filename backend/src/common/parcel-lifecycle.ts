...
export const PARCEL_STATUS_TRANSITIONS: Readonly<Record<ParcelStatus, readonly ParcelStatus[]>> = {
  ...
  assigned: [ParcelStatus.collected, ParcelStatus.in_transit, ParcelStatus.cancelled],
  ...
  at_transit_point: [ParcelStatus.assigned, ParcelStatus.in_transit, ParcelStatus.batch_transferred, ParcelStatus.cancelled],
